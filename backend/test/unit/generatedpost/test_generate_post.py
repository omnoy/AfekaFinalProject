...
def test_generate_post_generation_failed(client, auth, public_official_actions, httpx_mock: HTTPXMock):
    httpx_mock.add_response(
            method=responses.POST,
            url="https://api.anthropic.com/v1/messages",
            status_code=200,
    ...
    assert response.json["error"].endswith("No Stop Sequence Found in Response")
    
def test_generate_post_no_stop_sequence(client, auth, public_official_actions, httpx_mock: HTTPXMock):
    httpx_mock.add_response(
            method=responses.POST,
            url="https://api.anthropic.com/v1/messages",
            status_code=200,
